...
import io.curity.githubintegration.errors.ApiExceptionHandler
import io.curity.githubintegration.github.GitHubApiClient
    ...
    fun createPullRequest(@RequestBody(required = true) body: PullRequestInput): ResponseEntity<PullRequestOutput> {
        ...
        CoroutineScope(Dispatchers.IO).launch {
            ...
            try {
                ...
                val reader = ConfigurationReader(body.params, body.values)
                val client = GitHubApiClient(configuration)
                val pullRequestUrl = client.createAutomatedPullRequest(body, reader)
